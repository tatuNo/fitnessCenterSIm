...
/**
 * Luokka, joka määrittelee simulaattorin FIFO-tyyppisten palvelupisteiden toiminnnan. Näitä palvelupisteitä
 * simulaattorissa ovat fysioterapia, hieronta, röntgen ja vastaanotto.
...
public class Palvelupiste {
	...
	/** Tapahtuman tyyppi jota palvelupiste luo. */
	private TapahtumanTyyppi skeduloitavanTapahtumanTyyppi;
	/** Palveltujen asiakkaiden lukumäärä. */
	private int palveltutAsiakkaat;
	/** Aktiiviaika. */
	private double aktiiviaika;
	/** Palvelun aloitus hetki, käytetään aktiiviajan laskemisessa. */
	private double palvelunAloitus;
	/** Summamuuttuja läpimenoajoille. */
	private double lapimenoajat;
	/** Määrittelee onko palvelupiste varattu. */
